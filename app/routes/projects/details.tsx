...
const ProjectDetailsPage = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <>
      <Link
        to='/projects'
        className='flex gap-2 items-center text-blue-400 hover:text-blue-500 mb-6 transition'
      >
        <FaArrowLeft /> Regresar a Proyectos
      </Link>
      ...
      <div className='grid gap-8 md:grid-cols-2 items-start'>
        ...
        <div>
          ...
          >
            Visitar Sitio Web
            <FaArrowRight className='mx-2 inline-block' />
          </a>
        </div>
      </div>
    </>
